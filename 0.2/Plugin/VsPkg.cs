// VsPkg.cs : Implementation of Plugin
//
...
namespace MetaCommunity.Plugin
{
    ...
    [ProvideLoadKey("Standard", "1.0", "Meta", "Meta Community", 1)]
    // This attribute is needed to let the shell know that this package exposes some menus.
    [ProvideMenuResource(1000, 1)]
    [ProvideEditorExtension(typeof(EditorFactory), ".meta", 50, 
              ProjectGuid = "{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}", 
              TemplateDir = "..\\..\\Templates", 
              NameResourceID = 105,
              DefaultName = "Meta")]
    [ProvideKeyBindingTable(GuidList.guidPluginEditorFactoryString, 102)]
    [ProvideEditorLogicalView(typeof(EditorFactory), "{7651a703-06e5-11d1-8ebd-00a0c90f26ea}")]
    [Guid(GuidList.guidPluginPkgString)]
    public sealed class Plugin : Package
    {
