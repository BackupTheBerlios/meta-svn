...
namespace MetaCommunity.Plugin
{
    ...
    /// </summary>
    [Guid(GuidList.guidPluginEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private Plugin editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(Plugin package)
        {
        ...
        {
            // Removed the false parameter as it breaks other functionality such as the designer's context menu
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidPluginEditorFactory;
            pgrfCDW = 0;
            ...
            EditorPane NewEditor = new EditorPane(vsServiceProvider, editorPackage);
